...
class ControlRobot:
    ...
    def cerrar_pinza_remix(self):
        control = ControlRobot()
        print("Cerrando la pinza...")
        control.mover_pinza(0, 7.0)  # Cerrar a 6cm con 5N de fuerza
    ...
    def lectura_comodin(self):
        return 5

    def sort_blackjack(self):   
        print("D")   
...
if __name__ == '__main__':
    try:
        ...
        control.volver_base()
        control.abrir_pinza()
        control.sort_blackjack()
        control.finisher()
        control.cerrar_pinza_remix()
    except:
        pass
