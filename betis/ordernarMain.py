...
class ControlRobot:
    ...
    def creacion_objetos(self):
        ...
        control.add_box_from_config("OBJ1", "Caja_1")
        control.add_box_from_config("OBJ2", "Caja_2")
        control.add_box_from_config("OBJ3", "Caja_3")
        control.add_box_from_config("OBJ4", "Caja_4")
        control.add_box_from_config("OBJ5", "Caja_5")
...
if __name__ == '__main__':
    try:
        ...
        # Creamos los objetos
        control.creacion_objetos()

        # Programa Principal
        control.mover_configuracion("BASE")
        control.subir_pinza()

        control.mover_configuracion("CONFIG1")
        control.abrir_pinza()
        control.bajar_pinza()
        control.cerrar_pinza()
        control.subir_pinza()

        control.mover_configuracion("CONFIG3")
        control.bajar_pinza()
        control.abrir_pinza()
        control.subir_pinza()

        control.mover_configuracion("CONFIG2")
        control.bajar_pinza()
        control.cerrar_pinza()
        control.subir_pinza()
        ...
        control.mover_configuracion("BASE")
        control.mover_configuracion("FINISHER")
